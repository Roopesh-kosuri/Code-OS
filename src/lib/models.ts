...
glm: [
  ...
  "nvidia-nim": [
    { id: "meta/llama-3.2-11b-vision-instruct", name: "Llama 3.2 11B Vision", tag: "Flagship", description: "128K high-speed vision & agentic coding model on NVIDIA NIM" },
    { id: "moonshotai/kimi-k3", name: "Kimi K3 (Thinking)", tag: "Reasoning", description: "2.8T multimodal MoE with 1M context on NVIDIA NIM" },
    { id: "deepseek-ai/deepseek-v4-pro-0813", name: "DeepSeek V4 Pro", tag: "Reasoning", description: "DeepSeek V4 Pro reasoning model on NVIDIA NIM" },
    { id: "meta/muse-glimmer-30b", name: "Muse Glimmer 30B", tag: "Flagship", description: "Creative agentic foundation model on NVIDIA NIM" },
    { id: "nvidia/nemotron-3-nano-omni-30b-a3b-reasoning", name: "Nemotron 3 Nano Omni", tag: "Reasoning", description: "Compact reasoning and analysis model on NVIDIA NIM" },
    { id: "deepseek-ai/deepseek-r1", name: "DeepSeek R1", tag: "Reasoning", description: "DeepSeek R1 reasoning on TensorRT-LLM", available: false },
    { id: "nvidia/llama-3.1-nemotron-70b-instruct", name: "Nemotron 70B", tag: "Flagship", description: "128K NVIDIA-aligned 70B reasoning", available: false },
  ...
  groq: [
    ...
    { id: "qwen/qwen3.8-27b", name: "Qwen 3.8 27B", tag: "Recommended", description: "128K high-performance Qwen 3.8 on Groq LPU" },
    { id: "qwen/qwen3.6-27b", name: "Qwen 3.6 27B", tag: "Fast", description: "128K fast Qwen 3.6 on Groq LPU" },
    ...
    { id: "llama-3.3-70b-versatile", name: "Llama 3.3 70B", tag: "Flagship", description: "128K high-throughput 70B on LPU", available: false },
    { id: "llama-3.3-8b-versatile", name: "Llama 3.3 8B", tag: "Fast", description: "128K ultra-low latency 8B on LPU", available: false },
    { id: "llama-3.1-8b-instant", name: "Llama 3.1 8B Instant", tag: "Fast", description: "128K instant response model", available: false },
    { id: "llama-guard-4-12b", name: "Llama Guard 4 12B", tag: "Fast", description: "Safety moderation model", available: false },
    { id: "mixtral-8x7b-32768", name: "Mixtral 8x7B", tag: "Recommended", description: "32K MoE architecture on LPU", available: false },
    { id: "gemma2-9b-it", name: "Gemma 2 9B", tag: "Fast", description: "8K Google open model on Groq", available: false },
    { id: "deepseek-r1-distill-llama-70b", name: "DeepSeek R1 Distill 70B", tag: "Reasoning", description: "128K fast reasoning on Groq LPU", available: false },
    { id: "qwen-2.5-32b", name: "Qwen 2.5 32B", tag: "Recommended", description: "128K Qwen open model on Groq", available: false },
    { id: "qwen-2.5-coder-32b", name: "Qwen 2.5 Coder 32B", tag: "Coding", description: "128K code specialist on Groq", available: false },
  ],
  cohere: [
