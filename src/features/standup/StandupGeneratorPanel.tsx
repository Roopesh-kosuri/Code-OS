  ...
  return (
    <div className="flex flex-col h-full w-full bg-[#0d0e15] text-white select-none overflow-hidden" data-testid="standup-generator-panel">
      ...
      <div className="border-b border-white/5 bg-white/[0.01]">
        ...
        {showRawActivity && (
          <div className="px-3.5 pb-3 text-xs" data-testid="raw-activity-summary">
            <p className="text-white/80 font-mono text-[11px] bg-black/30 p-2 rounded-lg border border-white/5">
              {summaryText}
            </p>
          </div>
        )}
