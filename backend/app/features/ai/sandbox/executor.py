    ...
    try:
        ...
        try:
            ...
            if gov_task in done:
                ...
                # gov finished without hitting limits (process has exited).
                # communicate_task should be nearly done — wait briefly for it.
            ...
            if communicate_task in done:
                ...
                # Neither task completed within the timeout — kill the process.
                for t in pending:
                    t.cancel()
                try:
                    import psutil
