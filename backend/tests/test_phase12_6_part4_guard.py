...
PERMANENT_ALLOWLIST = {
    ...
    ("features/ai/harness/verify_runners.py", "create_verify_temp_dir"): "non-workspace (isolated temp dir outside workspace for JUnit XML and overlays)",
    ("features/ai/harness/verify_runners.py", "cleanup_verify_temp_dir"): "non-workspace (cleanup of isolated temp dir outside workspace)",
    ("features/ai/harness/verify_runners.py", "create_baseline_overlay"): "non-workspace (baseline workspace copy in isolated temp dir outside workspace)",
